...
<head>
<meta charset="UTF-8">
<title>Stickman War Game: Free Online Stickman Shooting Video Game for Kids</title>
        <meta name="description" content="Stickman War is a 27-level shooting gallery game where players either tap on the screen or use the mouse left click button to shoot running stickmen. Periodically reload by tapping on the button in the upper left corner. While you reload you are unable to shoot. Defeat all the stickmen to earn up to 3 stars on each stage. This is a JavaScript web application which uses cross-platform mobile-friendly HTML. All modern web browsers like Microsoft Edge, Apple Safari, Google Chrome, Mozilla Firefox and Opera should support it. This game works on just about any type of computing device including Microsoft Windows desktop computers, Apple OSX Mac computers, iOS powered tablets and phones like the iPad and iPhone,  laptops like the Google Chromebook, and the many types of mobile phones from manufacturers like Samsung which are powered by Google Android."/>
<link rel="canonical" href="https://www.culinaryschools.org/kids-games/stickman-war/" />
...
<noscript>
<h2>About Stickman War Game</h2>
<p>Stickman War is a 27-level shooting gallery game where players either tap on the screen or use the mouse left click button to shoot running stickmen. Periodically reload by tapping on the button in the upper left corner. While you reload you are unable to shoot. Defeat all the stickmen to earn up to 3 stars on each stage. This is a JavaScript web application which uses cross-platform mobile-friendly HTML. All modern web browsers like Microsoft Edge, Apple Safari, Google Chrome, Mozilla Firefox and Opera should support it. This game works on just about any type of computing device including Microsoft Windows desktop computers, Apple OSX Mac computers, iOS powered tablets and phones like the iPad and iPhone,  laptops like the Google Chromebook, and the many types of mobile phones from manufacturers like Samsung which are powered by Google Android.</p>
</noscript>
<noscript>
