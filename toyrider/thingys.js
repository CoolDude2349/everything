...
<title>Игра Машинка Гоняет по Комнате - Vseigru.net</title>
...
<script type="text/javascript">
	var options = {
		author: "Vseigru",
		logo: "logo.gif",
		gameName: "Машинка Гоняет по Комнате",
		gameNameEu: "Toy Rider",
		gameUrl: "41882",
		...
		loader: "unity2020",
		loaderOptions: {
			unityLoaderUrl: "Build/Toy Rider Yandex Games.loader.js",
			unityConfigOptions: {
				dataUrl: "Build/5988766fc1897591820e0b478edf5967.data.unityweb",
				frameworkUrl: "Build/ca74b758a8ad4593f43a7ae7adbd0a83.js.unityweb",
			    codeUrl: "Build/c7a0fbd204d6b8e2a10c3e04383864f3.wasm.unityweb",
