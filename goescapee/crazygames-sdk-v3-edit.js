    ...
    var e = {
        12: function(e, t, n) {
            ...
            t.throttledMethod = (e, t, n) => {
                ...
                return (...o) => {
                    ...
                    return s - r > t ? (r = s,
                    e(...o)) : void (n && i.error(`${n}() call throttled, delay ${t}`))
                }
            }
        },
        25: function(e, t, n) {
            ...
            t.loadGameDataFromLs = f,
            t.loadCachedCloudGameDataFromLs = g,
                ...
                return t.isQaTool ? (d.verbose("Running in QA tool, always using local data here"),
                {
                    ...
                    const r = async i => {
                        if ("sdkGameDataResponseNew" === i.data.type) {
                            d.verbose("Received game data from GF", i.data),
                            ...
                            if ("loaded" === o.status)
                                o.hasData ? e({
                                    ...
                                    if (u.SafeLocalStorage.Instance.getItem(n)) {
                                        ...
                                        d.verbose("Cloud data and local data missing, initialize with empty data"),
                                        e({
                                            data: {},
                                            handler: "cloud"
                                        })
                                ...
                                d.error("GF failed to load cloud game data, will load cached cloud data."),
                                (0,
                                s.sendErrorToGf)("gf-data-load-fail", "data");
                                const n = g(t.gameId);
                                d.verbose("Loaded cached cloud data, data will not be synced in this session", n),
                                e({
                                    data: n,
                                    handler: "cloud",
                                    doNotSync: !0
                    ...
                    ;
                    d.verbose("Requesting game data from GF"),
                    window.addEventListener("message", r, !1),
                    a.GF_WINDOW.postMessage({
                        type: "requestSdkGameDataNew"
                    }, "*"),
                    n = window.setTimeout(( () => {
                        d.error(`Did not get game data reply from GF in ${h}ms. Using cached cloud data if present. Disable data sync for this session.`),
                        (0,
            ...
            function f(e) {
                ...
                try {
                    ...
                    return d.error(`Failed to retrieve local game data (${t}), initializing empty data. Error ${e}`),
                    (0,
            ...
            function g(e) {
                const t = (0,
                l.generateCloudCacheLsGameDataKey)(e);
                try {
                    const e = u.SafeLocalStorage.Instance.getItem(t);
                    return e && JSON.parse(e).data || {}
                } catch (e) {
                    return d.error(`Failed to retrieve cached cloud game data from localStorage (${t}), initializing empty data. Error ${e}`),
                    (0,
        ...
        63: function(e, t, n) {
            ...
            t.LocalDataHandler = class {
                ...
                saveData() {
                    (0,
                    s.checkDataLimits)(JSON.stringify(this.data));
                    const e = {
                        data: this.data,
                        metadata: {
                            date: new Date
            ...
            t.default = class {
                ...
                async init(e) {
                    return this.initializingPromise || (this.initializingPromise = new Promise((async (t, n) => {
                        ...
                        g.checkIsLocalhost)()]);
                        if (i)
                            h.default.forceEnable = !0,
                            this.sdk = new _.default;
                        else if (r.isOnCrazyGames) {
                            if (!g.GF_WINDOW)
                                return n(new c.GeneralError("unexpectedError","Missing GF_WINDOW, even though running on CrazyGames"));
                            const [t,r] = await Promise.all([(0,
                            g.initSdk)(e), (0,
                            g.fetchSdkUser)()]);
                            if (null === t)
                            ...
                            const i = await (0,
                            d.prepareInitialGameData)(r, t);
                            this.sdk = new v.default(t,i,r);
                            try {
                                await (0,
                                l.loadAdsIfNeeded)(t.rafvertizingUrl, this.sdk)
                            } catch (e) {
                                (0,
                                f.sendErrorToGf)("ads-script-load-fail", "ad", {
                                    error: (0,
                                    u.stringifyError)(e)
                                }),
                        ...
                        r.render([i], {
                            ...
                            banner: {
                                callback: e => {
                                    ...
                                    !e.empty)
                                        return this.logger.log("Banner rendered", s, "with options", e),
        ...
        366: function(e, t, n) {
            ...
            t.renderFakeBanner = function(e) {
                ...
                if (e.isResponsive) {
                    const e = (0,
                    s.shuffle)(l).find((e => n >= e.width && r >= e.height));
                    if (!e)
                ...
                i.setAttribute("src", `${u}${n}x${r}.png`),
        ...
        543: function(e, t, n) {
            ...
            e = n.nmd(e),
            function() {
                var i, o = "Expected a function", s = "__lodash_hash_undefined__", a = "__lodash_placeholder__", u = 32, l = 128, c = 1 / 0, h = 9007199254740991, d = NaN, f = 4294967295, g = [["ary", l], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", 16], ["flip", 512], ["partial", u], ["partialRight", 64], ["rearg", 256]], p = "[object Arguments]", v = "[object Array]", y = "[object Boolean]", _ = "[object Date]", m = "[object Error]", w = "[object Function]", b = "[object GeneratorFunction]", k = "[object Map]", I = "[object Number]", E = "[object Object]", S = "[object Promise]", A = "[object RegExp]", M = "[object Set]", T = "[object String]", R = "[object Symbol]", D = "[object WeakMap]", P = "[object ArrayBuffer]", x = "[object DataView]", O = "[object Float32Array]", L = "[object Float64Array]", C = "[object Int8Array]", B = "[object Int16Array]", j = "[object Int32Array]", U = "[object Uint8Array]", G = "[object Uint8ClampedArray]", N = "[object Uint16Array]", q = "[object Uint32Array]", z = /\b__p \+= '';/g, F = /\b(__p \+=) '' \+/g, W = /(__e\(.*?\)|\b__t\)) \+\n'';/g, $ = /&(?:amp|lt|gt|quot|#39);/g, V = /[&<>"']/g, J = RegExp($.source), Q = RegExp(V.source), H = /<%-([\s\S]+?)%>/g, X = /<%([\s\S]+?)%>/g, Z = /<%=([\s\S]+?)%>/g, K = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Y = /^\w*$/, ee = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, te = /[\\^$.*+?()[\]{}|]/g, ne = RegExp(te.source), re = /^\s+/, ie = /\s/, oe = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, se = /\{\n\/\* \[wrapped with (.+)\] \*/, ae = /,? & /, ue = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, le = /[()=,{}\[\]\/\s]/, ce = /\\(\\)?/g, he = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, de = /\w*$/, fe = /^[-+]0x[0-9a-f]+$/i, ge = /^0b[01]+$/i, pe = /^\[object .+?Constructor\]$/, ve = /^0o[0-7]+$/i, ye = /^(?:0|[1-9]\d*)$/, _e = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, me = /($^)/, we = /['\n\r\u2028\u2029\\]/g, be = "\\ud800-\\udfff", ke = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Ie = "\\u2700-\\u27bf", Ee = "a-z\\xdf-\\xf6\\xf8-\\xff", Se = "A-Z\\xc0-\\xd6\\xd8-\\xde", Ae = "\\ufe0e\\ufe0f", Me = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Te = "[" + be + "]", Re = "[" + Me + "]", De = "[" + ke + "]", Pe = "\\d+", xe = "[" + Ie + "]", Oe = "[" + Ee + "]", Le = "[^" + be + Me + Pe + Ie + Ee + Se + "]", Ce = "\\ud83c[\\udffb-\\udfff]", Be = "[^" + be + "]", je = "(?:\\ud83c[\\udde6-\\uddff]){2}", Ue = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ge = "[" + Se + "]", Ne = "\\u200d", qe = "(?:" + Oe + "|" + Le + ")", ze = "(?:" + Ge + "|" + Le + ")", Fe = "(?:['’](?:d|ll|m|re|s|t|ve))?", We = "(?:['’](?:D|LL|M|RE|S|T|VE))?", $e = "(?:" + De + "|" + Ce + ")?", Ve = "[" + Ae + "]?", Je = Ve + $e + "(?:" + Ne + "(?:" + [Be, je, Ue].join("|") + ")" + Ve + $e + ")*", Qe = "(?:" + [xe, je, Ue].join("|") + ")" + Je, He = "(?:" + [Be + De + "?", De, je, Ue, Te].join("|") + ")", Xe = RegExp("['’]", "g"), Ze = RegExp(De, "g"), Ke = RegExp(Ce + "(?=" + Ce + ")|" + He + Je, "g"), Ye = RegExp([Ge + "?" + Oe + "+" + Fe + "(?=" + [Re, Ge, "$"].join("|") + ")", ze + "+" + We + "(?=" + [Re, Ge + qe, "$"].join("|") + ")", Ge + "?" + qe + "+" + Fe, Ge + "+" + We, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Pe, Qe].join("|"), "g"), et = RegExp("[" + Ne + be + ke + Ae + "]"), tt = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, nt = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], rt = -1, it = {};
                it[O] = it[L] = it[C] = it[B] = it[j] = it[U] = it[G] = it[N] = it[q] = !0,
                it[p] = it[v] = it[P] = it[y] = it[x] = it[_] = it[m] = it[w] = it[k] = it[I] = it[E] = it[A] = it[M] = it[T] = it[D] = !1;
                var ot = {};
                ot[p] = ot[v] = ot[P] = ot[x] = ot[y] = ot[_] = ot[O] = ot[L] = ot[C] = ot[B] = ot[j] = ot[k] = ot[I] = ot[E] = ot[A] = ot[M] = ot[T] = ot[R] = ot[U] = ot[G] = ot[N] = ot[q] = !0,
                ot[m] = ot[w] = ot[D] = !1;
                var st = {
                    "\\": "\\",
                    "'": "'",
                ...
                var fn = Wt({
                  ...
                  , gn = function e(t) {
                    var n, r = (t = null == t ? ht : gn.defaults(ht.Object(), t, gn.pick(ht, nt))).Array, ie = t.Date, be = t.Error, ke = t.Function, Ie = t.Math, Ee = t.Object, Se = t.RegExp, Ae = t.String, Me = t.TypeError, Te = r.prototype, Re = ke.prototype, De = Ee.prototype, Pe = t["__core-js_shared__"], xe = Re.toString, Oe = De.hasOwnProperty, Le = 0, Ce = (n = /[^.]+$/.exec(Pe && Pe.keys && Pe.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "", Be = De.toString, je = xe.call(Ee), Ue = ht._, Ge = Se("^" + xe.call(Oe).replace(te, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ne = gt ? t.Buffer : i, qe = t.Symbol, ze = t.Uint8Array, Fe = Ne ? Ne.allocUnsafe : i, We = sn(Ee.getPrototypeOf, Ee), $e = Ee.create, Ve = De.propertyIsEnumerable, Je = Te.splice, Qe = qe ? qe.isConcatSpreadable : i, He = qe ? qe.iterator : i, Ke = qe ? qe.toStringTag : i, et = function() {
                        try {
                            var e = uo(Ee, "defineProperty");
                            return e({}, "", {}),
                            e
                        } catch (e) {}
                    }(), st = t.clearTimeout !== ht.clearTimeout && t.clearTimeout, lt = ie && ie.now !== ht.Date.now && ie.now, ct = t.setTimeout !== ht.setTimeout && t.setTimeout, dt = Ie.ceil, ft = Ie.floor, pt = Ee.getOwnPropertySymbols, vt = Ne ? Ne.isBuffer : i, Bt = t.isFinite, Wt = Te.join, pn = sn(Ee.keys, Ee), vn = Ie.max, yn = Ie.min, _n = ie.now, mn = t.parseInt, wn = Ie.random, bn = Te.reverse, kn = uo(t, "DataView"), In = uo(t, "Map"), En = uo(t, "Promise"), Sn = uo(t, "Set"), An = uo(t, "WeakMap"), Mn = uo(Ee, "create"), Tn = An && new An, Rn = {}, Dn = jo(kn), Pn = jo(In), xn = jo(En), On = jo(Sn), Ln = jo(An), Cn = qe ? qe.prototype : i, Bn = Cn ? Cn.valueOf : i, jn = Cn ? Cn.toString : i;
                    function Un(e) {
                    ...
                    function Qn(e, t) {
                        var n = Fs(e)
                          ...
                          , u = a.length;
                        for (var l in e)
                            !t && !Oe.call(e, l) || s && ("length" == l || i && ("offset" == l || "parent" == l) || o && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || vo(l, u)) || a.push(l);
                        return a
                    }
                    function Hn(e) {
                        var t = e.length;
                    ...
                    function Xn(e, t) {
                        return xo(Ai(e), or(t, 0, e.length))
                    }
                    function Zn(e) {
                        return xo(Ai(e))
                    }
                    ...
                    function Yn(e, t, n) {
                        var r = e[t];
                        Oe.call(e, t) && Gs(r, n) && (n !== i || t in e) || rr(e, t, n)
                    }
                    function er(e, t) {
                    ...
                    function pr(e, t, n, r, i) {
                        ...
                        i || (i = []); ++o < s; ) {
                            var a = e[o];
                            t > 0 && n(a) ? t > 1 ? pr(a, t - 1, n, r, i) : xt(i, a) : r || (i[i.length] = a)
                        }
                        return i
                    }
                    var vr = Pi()
                    ...
                    function Tr(e, t, n) {
                        var r = null == (e = So(e, t = vi(t, e))) ? e : e[Bo(Ho(t))];
                    ...
                    function Dr(e, t, n, r, o) {
                        return e === t || (null == e || null == t || !ea(e) && !ea(t) ? e != e && t != t : function(e, t, n, r, o, s) {
                            ...
                            if (f && !h)
                                return s || (s = new Jn),
                                a || ua(e) ? Ki(e, t, n, r, o, s) : function(e, t, n, r, i, o, s) {
                                    switch (n) {
                                    case x:
                    ...
                    function xr(e) {
                        return !(!Ys(e) || (t = e,
                        Ce && Ce in t)) && (Xs(e) ? Ge : pe).test(jo(e));
                        var t
                    }
                    function Or(e) {
                        return "function" == typeof e ? e : null == e ? nu : "object" == typeof e ? Fs(e) ? Ur(e[0], e[1]) : jr(e) : hu(e)
                    }
                    function Lr(e) {
                        if (!bo(e))
                            return pn(e);
                    ...
                    function Ur(e, t) {
                        return _o(e) && ko(t) ? Io(Bo(e), t) : function(n) {
                            var r = Sa(n, e);
                                    ...
                                    if (c)
                                        ...
                                        if (d) {
                                            var f = Fs(l)
                                              ...
                                              , p = !f && !g && ua(l);
                                            h = l,
                                            f || g || p ? Fs(u) ? h = u : Vs(u) ? h = Ai(u) : g ? (d = !1,
                                            h = wi(l, !0)) : p ? (d = !1,
                                            h = ki(l, !0)) : h = [] : ra(l) || zs(l) ? (h = u,
                                            zs(u) ? h = va(u) : Ys(u) && !Xs(u) || (h = go(l))) : d = !1
                                        }
                                        d && (a.set(l, h),
                                        o(h, l, r, s, a),
                                        a.delete(l)),
                    ...
                    function Xr(e, t, n, r) {
                        ...
                        for (var o = -1, s = (t = vi(t, e)).length, a = s - 1, u = e; null != u && ++o < s; ) {
                            ...
                            if (o != a) {
                                var h = u[l];
                                (c = r ? r(h, l, u) : i) === i && (c = Ys(h) ? h : vo(t[o + 1]) ? [] : {})
                            }
                            Yn(u, l, c),
                            u = u[l]
                        }
                    ...
                    function ui(e, t) {
                        return null == (e = So(e, t = vi(t, e))) || delete e[Bo(Ho(t))]
                    }
                    function li(e, t, n, r) {
                    ...
                    function vi(e, t) {
                        return Fs(e) ? e : _o(e, t) ? [e] : Co(ya(e))
                    }
                    var yi = Jr;
                    function _i(e, t, n) {
                        var r = e.length;
                    ...
                    function Ei(e, t, n, i) {
                        for (var o = -1, s = e.length, a = n.length, u = -1, l = t.length, c = vn(s - a, 0), h = r(l + c), d = !i; ++u < l; )
                            h[u] = t[u];
                        for (; ++o < a; )
                            (d || o < s) && (h[n[o]] = e[o]);
                        for (; c--; )
                    ...
                    function Oi(e) {
                        return function(t) {
                            return Ot(Xa(za(t).replace(Xe, "")), e, "")
                        }
                    }
                    function Li(e) {
                        return function() {
                    ...
                    function ji(e, t, n, o, s, a, u, c, h, d) {
                        var f = t & l
                          , g = 1 & t
                          , p = 2 & t
                          , v = 24 & t
                        ...
                        return function l() {
                            ...
                            v && m < d) {
                                var E = an(w, k);
                                return Wi(e, t, ji, l.placeholder, n, w, E, c, h, d - m)
                            }
                            var S = g ? n : this
                              , A = p ? S[e] : e;
                            return m = w.length,
                            ...
                            f && h < m && (w.length = h),
                            this && this !== ht && this instanceof l && (A = _ || Li(A)),
                            A.apply(S, w)
                        }
                    }
                    function Ui(e, t) {
                    ...
                    function zi(e) {
                        return function(t, n, o) {
                            ...
                            t = 0) : n = da(n),
                            function(e, t, n, i) {
                                for (var o = -1, s = vn(dt((t - e) / (n || 1)), 0), a = r(s); s--; )
                                    a[i ? s : ++o] = e,
                                    e += n;
                                return a
                    ...
                    function Fi(e) {
                        return function(t, n) {
                            return "string" == typeof t && "string" == typeof n || (t = pa(t),
                            n = pa(n)),
                            e(t, n)
                        }
                    }
                    ...
                    function Qi(e, t, n, s, c, h, d, f) {
                        ...
                        s = m[3],
                        c = m[4],
                        !(f = m[9] = m[9] === i ? g ? 0 : e.length : vn(m[9] - p, 0)) && 24 & t && (t &= -25),
                        t && 1 != t)
                            w = 8 == t || 16 == t ? function(e, t, n) {
                                var o = Li(e);
                                return function s() {
                                    for (var a = arguments.length, u = r(a), l = a, c = io(s); l--; )
                                        u[l] = arguments[l];
                                    var h = a < 3 && u[0] !== c && u[a - 1] !== c ? [] : an(u, c);
                                    return (a -= h.length) < n ? Wi(e, t, ji, s.placeholder, i, u, h, i, i, n - a) : It(this && this !== ht && this instanceof s ? o : e, this, u)
                                }
                            }(e, t, f) : t != u && 33 != t || c.length ? ji.apply(i, m) : function(e, t, n, i) {
                                var o = 1 & t
                                  , s = Li(e);
                                return function t() {
                                    for (var a = -1, u = arguments.length, l = -1, c = i.length, h = r(c + u), d = this && this !== ht && this instanceof t ? s : e; ++l < c; )
                                        h[l] = i[l];
                                    for (; u--; )
                                        h[l++] = arguments[++a];
                    ...
                    function Hi(e, t, n, r) {
                        return e === i || Gs(e, De[n]) && !Oe.call(r, n) ? t : e
                    }
                    function Xi(e, t, n, r, o, s) {
                        return Ys(e) && Ys(t) && (s.set(t, e),
                        Gr(e, t, i, Xi, s),
                        s.delete(t)),
                        e
                    }
                    ...
                    : au;
                    function ro(e) {
                        for (var t = e.name + "", n = Rn[t], r = Oe.call(Rn, t) ? n.length : 0; r--; ) {
                            var i = n[r]
                              , o = i.func;
                            if (null == o || o == e)
                                return i.name
                    ...
                    function io(e) {
                        return (Oe.call(Un, "placeholder") ? Un : e).placeholder
                    }
                    function oo() {
                    ...
                    function fo(e, t, n) {
                        ...
                        return o || ++r != i ? o : !!(i = null == e ? 0 : e.length) && Ks(i) && vo(s, i) && (Fs(e) || zs(e))
                    }
                    function go(e) {
                        return "function" != typeof e.constructor || bo(e) ? {} : Gn(We(e))
                    }
                    function po(e) {
                    ...
                    function yo(e, t, n) {
                        if (!Ys(n))
                            return !1;
                        var r = typeof t;
                        return !!("number" == r ? $s(n) && vo(t, n.length) : "string" == r && t in n) && Gs(n[t], e)
                    }
                    function _o(e, t) {
                        if (Fs(e))
                            return !1;
                        var n = typeof e;
                        return !("number" != n && "symbol" != n && "boolean" != n && null != e && !aa(e)) || Y.test(e) || !K.test(e) || null != t && e in Ee(t)
                    }
                    function mo(e) {
                        var t = ro(e)
                          , n = Un[t];
                    ...
                    (kn && ho(new kn(new ArrayBuffer(1))) != x || In && ho(new In) != k || En && ho(En.resolve()) != S || Sn && ho(new Sn) != M || An && ho(new An) != D) && (ho = function(e) {
                        var t = Ir(e)
                    ...
                    var Go = Jr((function(e, t) {
                      ...
                      , No = Jr((function(e, t) {
                        var n = Ho(t);
                        return Vs(n) && (n = i),
                        Vs(e) ? lr(e, pr(t, 1, Vs, !0), oo(n, 2)) : []
                    }
                    ))
                      , qo = Jr((function(e, t) {
                        var n = Ho(t);
                        return Vs(n) && (n = i),
                        Vs(e) ? lr(e, pr(t, 1, Vs, !0), i, n) : []
                    }
                    ));
                    function zo(e, t, n) {
                    ...
                    var Vo = Jr((function(e) {
                      ...
                      , Jo = Jr((function(e) {
                        var t = Ho(e)
                          , n = Pt(e, gi);
                        return t === Ho(n) ? t = i : n.pop(),
                        n.length && n[0] === e[0] ? Mr(n, oo(t, 2)) : []
                    }
                    ))
                      , Qo = Jr((function(e) {
                        var t = Ho(e)
                    ...
                    function Ds(e, t, n) {
                        var r, s, a, u, l, c, h = 0, d = !1, f = !1, g = !0;
                        if ("function" != typeof e)
                            throw new Me(o);
                        function p(t) {
                            var n = r
                    ...
                    var Cs = yi((function(e, t) {
                        var n = (t = 1 == t.length && Fs(t[0]) ? Pt(t[0], Ht(oo())) : Pt(pr(t, 1), Ht(oo()))).length;
                    ...
                    var Ns = Fi(Er)
                      ...
                      , zs = Rr(function() {
                        ...
                        return ea(e) && Oe.call(e, "callee") && !Ve.call(e, "callee")
                    }
                      , Fs = r.isArray
                      , Ws = yt ? Ht(yt) : function(e) {
                        return ea(e) && Ir(e) == P
                    }
                    ;
                    function $s(e) {
                        return null != e && Ks(e.length) && !Xs(e)
                    }
                    function Vs(e) {
                        return ea(e) && $s(e)
                    }
                    var Js = vt || pu
                      , Qs = _t ? Ht(_t) : function(e) {
                        return ea(e) && Ir(e) == _
                    }
                    ;
                    function Hs(e) {
                      ...
                      , Ia = Jr((function(e, t) {
                        ...
                        for (o && yo(t[0], t[1], o) && (r = 1); ++n < r; )
                            for (var s = t[n], a = Pa(s), u = -1, l = a.length; ++u < l; ) {
                                var c = a[u]
                                  , h = e[c];
                                (h === i || Gs(h, De[c]) && !Oe.call(e, c)) && (e[c] = s[c])
                            }
                        return e
                    }
                    ))
                    ...
                    var Ma = Ui((function(e, t, n) {
                      ...
                      , Ra = Jr(Tr);
                    function Da(e) {
                        return $s(e) ? Qn(e) : Lr(e)
                    }
                    function Pa(e) {
                        return $s(e) ? Qn(e, !0) : function(e) {
                            if (!Ys(e))
                                return function(e) {
                                    var t = [];
                                    if (null != e)
                    ...
                    var xa = Ri((function(e, t, n) {
                        Gr(e, t, n)
                    }
                    ))
                      , Oa = Ri((function(e, t, n, r) {
                        Gr(e, t, n, r)
                    }
                    ))
                      , La = Yi((function(e, t) {
                    ...
                    function ru(e) {
                        return Or("function" == typeof e ? e : sr(e, 1))
                    }
                    ...
                    function su(e, t, n) {
                        var r = Da(t)
                          , i = wr(t, r);
                        null != n || Ys(t) && (i.length || !r.length) || (n = t,
                        t = e,
                        e = this,
                        i = wr(t, Da(t)));
                    ...
                    var uu = Ni(Pt)
                      ...
                      , cu = Ni(Ct);
                    function hu(e) {
                        return _o(e) ? Ft(Bo(e)) : function(e) {
                            return function(t) {
                                return br(t, e)
                            }
                        }(e)
                    ...
                    var vu, yu = Gi((function(e, t) {
                        return e + t
                    }
                    ), 0), _u = $i("ceil"), mu = Gi((function(e, t) {
                        return e / t
                    }
                    ), 1), wu = $i("floor"), bu = Gi((function(e, t) {
                        return e * t
                    }
                    ), 1), ku = $i("round"), Iu = Gi((function(e, t) {
                        return e - t
                    }
                    ), 0);
                    ...
                    Un.fill = function(e, t, n, r) {
                        ...
                        function(e, t, n, r) {
                            var o = e.length;
                            for ((n = fa(n)) < 0 && (n = -n > o ? 0 : o + n),
                            (r = r === i || r > o ? o : fa(r)) < 0 && (r += o),
                            r = n > r ? 0 : ga(r); n < r; )
                                e[n++] = t;
                            return e
                        }(e, t, n, r)) : []
                    ...
                    Un.sampleSize = function(e, t, n) {
                        return t = (n ? yo(e, t, n) : t === i) ? 1 : fa(t),
                        (Fs(e) ? Xn : Hr)(e, t)
                    }
                    ,
                    ...
                    Un.split = function(e, t, n) {
                        ...
                        (n = n === i ? f : n >>> 0) ? (e = ya(e)) && ("string" == typeof t || null != t && !ia(t)) && !(t = si(t)) && rn(e) ? _i(hn(e), 0, n) : e.split(t, n) : []
                    }
                    ,
                    Un.spread = function(e, t) {
                        if ("function" != typeof e)
                            throw new Me(o);
                        return t = null == t ? 0 : vn(fa(t), 0),
                        Jr((function(n) {
                            var r = n[t]
                              , i = _i(n, 0, t);
                            return r && xt(i, r),
                    ...
                    Un.toPath = function(e) {
                        return Fs(e) ? Pt(e, Bo) : aa(e) ? [e] : Ai(Co(ya(e)))
                    }
                    ,
                    Un.toPlainObject = va,
                    ...
                    Un.escape = function(e) {
                        return (e = ya(e)) && Q.test(e) ? e.replace(V, tn) : e
                    }
                    ,
                    ...
                    Un.includes = function(e, t, n, r) {
                        ...
                        sa(e) ? n <= i && e.indexOf(t, n) > -1 : !!i && Gt(e, t, n) > -1
                    }
                    ,
                    ...
                    Un.isEmpty = function(e) {
                        if (null == e)
                            return !0;
                        if ($s(e) && (Fs(e) || "string" == typeof e || "function" == typeof e.splice || Js(e) || ua(e) || zs(e)))
                            return !e.length;
                        var t = ho(e);
                        if (t == k || t == M)
                            return !e.size;
                    ...
                    Un.lastIndexOf = function(e, t, n) {
                        ...
                        if (!r)
                            return -1;
                        var o = r;
                        return n !== i && (o = (o = fa(n)) < 0 ? vn(r + o, 0) : yn(o, r - 1)),
                        t == t ? function(e, t, n) {
                            for (var r = n + 1; r--; )
                                if (e[r] === t)
                                    return r;
                    ...
                    ,
                    Un.min = function(e) {
                        return e && e.length ? fr(e, nu, Cr) : i
                    }
                    ,
                    Un.minBy = function(e, t) {
                        return e && e.length ? fr(e, oo(t, 2), Cr) : i
                    }
                    ,
                    Un.stubArray = gu,
                    Un.stubFalse = pu,
                    ...
                    Un.multiply = bu,
                    Un.nth = function(e, t) {
                        return e && e.length ? Nr(e, fa(t)) : i
                    }
                    ,
                    Un.noConflict = function() {
                        return ht._ === this && (ht._ = Ue),
                        this
                    }
                    ,
                    Un.noop = au,
                    ...
                    Un.template = function(e, t, n) {
                        ...
                        e = ya(e),
                        t = wa({}, t, r, Hi);
                        var o, s, a = wa({}, t.imports, r.imports, Hi), u = Da(a), l = Xt(a, u), c = 0, h = t.interpolate || me, d = "__p += '", f = Se((t.escape || me).source + "|" + h.source + "|" + (h === Z ? he : me).source + "|" + (t.evaluate || me).source + "|$", "g"), g = "//# sourceURL=" + (Oe.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++rt + "]") + "\n";
                        ...
                        d += "';\n";
                        var p = Oe.call(t, "variable") && t.variable;
                        if (p) {
                            if (le.test(p))
                    ...
                    Un.truncate = function(e, t) {
                        ...
                        ia(o)) {
                            if (e.slice(u).search(o)) {
                                var c, h = l;
                                for (o.global || (o = Se(o.source, ya(de.exec(o)) + "g")),
                    ...
                    zn.prototype.slice = function(e, t) {
                        e = fa(e);
                        var n = this;
                        return n.__filtered__ && (e > 0 || t < 0) ? new zn(n) : (e < 0 ? n = n.takeRight(-e) : e && (n = n.drop(e)),
                        t !== i && (n = (t = fa(t)) < 0 ? n.dropRight(-t) : n.take(t - e)),
                        n)
                    }
                    ,
                    ...
                    _r(zn.prototype, (function(e, t) {
                        ...
                        o && (Un.prototype[t] = function() {
                            ...
                            return g && p ? e.apply(this, a) : (v = this.thru(h),
        ...
        589: function(e, t, n) {
            ...
            t.default = class {
                ...
                async prefetchBanner(e) {
                    ...
                    !(0,
                    u.matchesInGameBannerSize)(e.width, e.height))
            ...
            t.default = class {
                constructor() {
                    ...
                    this.showInviteButton = e => {
                        ...
                        const t = (0,
                        u.generateInviteLink)(e, this.game.link);
        ...
        617: function(e, t, n) {
            ...
            t.default = class {
                ...
                inviteLink(e) {
                    ...
                    const t = (0,
                    i.generateInviteLink)(e, this.link);
        ...
        637: (e, t, n) => {
            ...
            ;
            const r = n(833)
              , i = ["728x90", "300x250", "320x50", "468x60", "320x100"];
            function o(e) {
                return i.some((t => t === e))
            }
            ...
            t.default = class {
                constructor(e, t, n) {
                    ...
                    this.receiveMessage = async e => {
                        const t = e.data;
                        (0,
                        u.isGfToSdkEvent)(t) && t.type && (this.logger.verbose("Received message from GF", t),
                ...
                return new Promise(( (t, n) => {
                    ...
                    i.onerror = (e, t, i, o, s) => {
                        try {
                            ...
                            n(new Error(`LoadScript error. Event [${a}]- source [${t}] - line/column [${i}/${o}] - error [${(0,
                            r.stringifyError)(s)}]`))
                        } catch (e) {
                            n(e)
                        }
        ...
        924: function(e, t, n) {
            ...
            t.default = class {
                ...
                handleAuthPromptResponse(e) {
                    ...
                    t ? this.authDeferredPromise && this.authDeferredPromise.reject(new o.UserError(t.code,t.message)) : (this.user = null != n ? n : null,
                ...
                async getUserToken() {
                    ...
                    if ((0,
                    a.isDefined)(e) && (0,
                    s.isJsSdkRequestUserTokenSuccessResponse)(e))
                    ...
                    if ((0,
                    s.isJsSdkRequestUserTokenErrorResponse)(e))
                ...
                handleUserTokenResponse(e) {
                    ...
                    this.userTokenRequestInProgress = !1,
                    (0,
                    s.isJsSdkRequestUserTokenSuccessResponse)(e) && (this.tokenExpiresAtMs = Date.now() + 1e3 * e.expiresIn),
                ...
                async getXsollaUserToken() {
                    ...
                    if ((0,
                    a.isDefined)(e) && (0,
                    s.isJsSdkRequestXsollaUserTokenSuccessResponse)(e))
                    ...
                    if ((0,
                    s.isJsSdkRequestXsollaUserTokenErrorResponse)(e))
                        throw new o.UserError(e.error.code,e.error.message);
                    if (!e.token)
                ...
                handleXsollaUserTokenResponse(e) {
                    ...
                    this.xsollaUserTokenRequestInProgress = !1,
                    (0,
                    s.isJsSdkRequestXsollaUserTokenSuccessResponse)(e) && (this.xsollaUserTokenExpiresAtMs = Date.now() + 1e3 * e.expiresIn),
                ...
                addScoreEncrypted(e, t) {
                    ...
                    "number" != typeof e || isNaN(e))
                        ...
                        new o.UserError("invalidScoreFormat","Score input must be a number");
                    if ("https:" !== window.location.protocol)
                        throw this.logger.error("AddScore is only supported on https"),
                        new o.UserError("unexpectedError","AddScore is only supported on https");
        ...
        925: function(e, t, n) {
            ...
            t.initSdk = function(e) {
                return new Promise((n => {
                    const r = window.setTimeout(( () => {
                        ...
                        c.error(`Gf Init response timeout ${h}ms`),
                        n(null)
                    }
                    ), h)
                      , i = async e => {
            ...
            t.fetchSdkUser = function() {
                return new Promise((e => {
                    const t = window.setTimeout(( () => {
                        ...
                        c.error(`Gf user response timeout ${d}ms, continuing with "null" (signed out) user`),
                        e(null)
                    }
                    ), d)
                      , n = async r => {
            ...
            t.checkIsLocalhost = async function() {
                if (["http://localhost:4000/gameframe-unity56-standalone/", "http://localhost:4000/gameframe-unity56/", "http://localhost:4000/gameframe-standalone/", "http://localhost:4000/gameframe/"].some((e => window.location.href.startsWith(e))))
                    return !1;
                const e = ["localhost", "127.0.0.1", "preview.construct.net"].includes("localhost") || "true" === (0,
        ...
        985: function(e, t, n) {
            ...
            t.default = class {
                ...
                handleEvent(e) {
                    ...
                    case "adError":
                        this.requestInProgress = !1;
                        const r = new s.AdError((null === (t = e.error) || void 0 === t ? void 0 : t.reason) || "other",(null === (n = e.error) || void 0 === n ? void 0 : n.message) || "Unknown message");
                        return this.adPlaying = !1,
                        (0,
                        i.wrapUserFn)(this.adCallbacks.adError)(r);
                    case "adFinished":
                        return this.adPlaying = !1,
                        this.requestInProgress = !1,
                        (0,
