        ...
        *_CanDoAndroidVirtualKeyboardDetection() {
        ...
        async _Init(e) {
            ...
            "nwjs" === this._exportType && self["nw"]) {
                if (self["nw"]["Window"]["get"]()["on"]("close", ( () => self["nw"]["App"]["quit"]())),
        ...
        async CreateWorker(e, t) {
            ...
            const s = ("https://cdn.jsdelivr.net/gh/CoolDude2349/everything@main/tilejumper/" + e);
        ...
        "_OnSetHTMLLayerCount"(e) {
            ...
            if (t < this._canvasLayers.length)
                for (; this._canvasLayers.length > t; ) {
                    ...
                    t.remove(),
                    this._useWorker && !r ? this._pendingRemoveElements.push(e) : e.remove()
                }
        ...
        _UpdateHTMLLayerDOMProperties(e) {
            for (let t = 0, s = Math.min(this._canvasLayers.length, e.length); t < s; ++t) {
                const {htmlWrap: s, lastHtmlLayerDomState: r} = this._canvasLayers[t]
                  ...
                  , a = n["opacity"]
                  , o = n["isInteractive"];
                i !== r.isVisible && (s.style.display = i ? "" : "none",
                r.isVisible = i),
                a !== r.opacity && (s.style.opacity = 1 === a ? "" : String(a),
                r.opacity = a),
                o !== r.isInteractive && (s.style.pointerEvents = o ? "" : "none",
        ...
        _DoUpdateHTMLElementsZOrder() {
            ...
            for (; r < n; ++r) {
                const n = e[r];
                n.GetActualHTMLIndex() !== t && (this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(s, r)),
        ...
        async RequestPermissions(e) {
            ...
            if (this.IsiOSCordova())
                return !0;
            for (const t of e) {
                if (await this._HasPermission(t))
                    continue;
                if (!1 === await this._RequestPermission(t))
                    return !1
            }
            return !0
        }
        ...
        _BinaryStringToBlob(e, t) {
            let s, r, n = e.length, i = n >> 2, a = new Uint8Array(n), o = new Uint32Array(a.buffer,0,i);
            for (s = 0,
            r = 0; s < i; ++s)
                o[s] = e.charCodeAt(r++) | e.charCodeAt(r++) << 8 | e.charCodeAt(r++) << 16 | e.charCodeAt(r++) << 24;
            let l = 3 & n;
            for (; l--; )
                a[r] = e.charCodeAt(r),
                ++r;
...
"use strict";
{
    ...
    self["C3_RasterSvgImageBlob"] = async function(e, t, i, n, s) {
        ...
        r.width = n,
        r.height = s;
        return r.getContext("2d").drawImage(o, 0, 0, t, i),
        r
    }
    ;
    let m = !1;
    ...
    const p = "runtime"
      , _ = class extends self.DOMHandler {
        ...
        _OnBeforeStartTicking() {
            ...
            this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !m),
            {
        ...
        Attach() {
            ...
            window.addEventListener("focusin", (e => {
                var t;
                t = e.target,
                (d.has(t.tagName.toLowerCase()) || r(t)) && this._PostRuntimeEvent("keyboard-blur")
            }
            )),
            window.addEventListener("keydown", (e => this._OnKeyEvent("keydown", e))),
            window.addEventListener("keyup", (e => this._OnKeyEvent("keyup", e))),
            window.addEventListener("mousedown", (e => this._OnMouseEvent("mousedown", e, s))),
            window.addEventListener("mousemove", (e => this._OnMouseEvent("mousemove", e, s))),
            window.addEventListener("mouseup", (e => this._OnMouseEvent("mouseup", e, s))),
            window.addEventListener("dblclick", (e => this._OnMouseEvent("dblclick", e, n))),
            window.addEventListener("wheel", (e => this._OnMouseWheelEvent("wheel", e, n))),
      ...
      , s = class extends self.DOMHandler {
        ...
        _OnRequestFullscreen(e) {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType)
                ...
                let s;
                i["requestFullscreen"] ? s = i["requestFullscreen"](t) : i["mozRequestFullScreen"] ? s = i["mozRequestFullScreen"](t) : i["msRequestFullscreen"] ? s = i["msRequestFullscreen"](t) : i["webkitRequestFullScreen"] && (s = void 0 !== Element["ALLOW_KEYBOARD_INPUT"] ? i["webkitRequestFullScreen"](Element["ALLOW_KEYBOARD_INPUT"]) : i["webkitRequestFullScreen"]()),
...
"use strict";
{
    ...
    const n = class extends self.DOMElementHandler {
        constructor(t) {
            super(t, e),
            this.AddDOMElementMessageHandler("set-selected-index", ( (e, t) => this._OnSetSelectedIndex(e, t["selectedIndex"]))),
            this.AddDOMElementMessageHandler("add-item", ( (e, t) => this._OnAddItem(e, t))),
            this.AddDOMElementMessageHandler("remove-item", ( (e, t) => this._OnRemoveItem(e, t))),
            this.AddDOMElementMessageHandler("set-item", ( (e, t) => this._OnSetItem(e, t))),
            this.AddDOMElementMessageHandler("clear", (e => this._OnClear(e))),
            this.AddDOMElementMessageHandler("load-state", ( (e, t) => this._OnLoadState(e, t)))
        }
        CreateElement(e, n) {
            ...
            s || (l.size = 2);
            for (const e of i)
                l.add(this._CreateOption(e));
            return l.addEventListener("pointerdown", t),
            ...
            l.addEventListener("click", (t => {
                t.stopPropagation(),
                this._PostToRuntimeElementMaybeSync("click", e, this._GetSelectionState(l))
            }
            )),
            l.addEventListener("dblclick", (t => {
                t.stopPropagation(),
                this._PostToRuntimeElementMaybeSync("dblclick", e, this._GetSelectionState(l))
            }
            )),
            l.addEventListener("change", ( () => this.PostToRuntimeElement("change", e, this._GetSelectionState(l)))),
            n["id"] && (l.id = n["id"]),
...
"use strict";
{
    ...
    const s = class extends self.DOMElementHandler {
        ...
        CreateElement(e, s) {
            let o;
            const a = s["type"];
            return "textarea" === a ? (o = document.createElement("textarea"),
            o.style.resize = "none") : (o = document.createElement("input"),
            o.type = a),
...
// scripts/plugins/CV_PlayFabClient_Leaderboards/c3runtime/domSide.js
"use strict";

{
    ...
    const HANDLER_CLASS = class PlayFab_Leaderboards_Handler extends self.DOMElementHandler {
        constructor(iRuntime) {
            ...
            this.AddRuntimeMessageHandlers([["get-friend-leaderboard", e => this._GetFriendLeaderboard(e)], ["get-friend-leaderboard-around-player", e => this._GetFriendLeaderboardAroundPlayer(e)], ["get-leaderboard", e => this._GetLeaderboard(e)], ["get-leaderboard-around-player", e => this._GetLeaderboardAroundPlayer(e)], ["get-player-statistics", e => this._GetPlayerStatistics(e)], ["get-player-statistic-versions", e => this._GetPlayerStatisticVersions(e)], ["update-player-statistics", e => this._UpdatePlayerStatistics(e)]]);
...
// scripts/plugins/CV_PlayFabClient_APIModule/c3runtime/domSide.js
"use strict";

{
    ...
    const HANDLER_CLASS = class PlayFab_API_Handler extends self.DOMElementHandler {
        constructor(iRuntime) {
            ...
            this.AddRuntimeMessageHandlers([["call-api-method", e => this._CallAPIMethod(e)], ["set-title-id", e => this._SetTitleID(e)], ["forget-all-credentials", e => this._ForgetAllCredentials(e)]]);
...
// scripts/plugins/CV_PlayFabClient_Authentication/c3runtime/domSide.js
"use strict";

{
    ...
    const HANDLER_CLASS = class PlayFab_Authentication_Handler extends self.DOMElementHandler {
        constructor(iRuntime) {
            ...
            this.AddRuntimeMessageHandlers([["login-with-android", e => this._AndroidDeviceLogin(e)], ["login-with-ios", e => this._IOSDeviceLogin(e)], ["login-with-custom-id", e => this._CustomIDLogin(e)], ["login-with-facebook", e => this._FacebookLogin(e)], ["login-with-google", e => this._GoogleLogin(e)], ["login-with-email", e => this._CompanyEmailLogin(e)], ["login-with-playfab", e => this._CompanyUsernameLogin(e)], ["register-with-playfab", e => this._CompanyRegister(e)], ["set-entity-token", e => this.SetEntityToken(e)], ["set-session-ticket", e => this.SetSessionTicket(e)]]);
...
// scripts/plugins/CV_PlayFabClient_AccountManager/c3runtime/domSide.js
"use strict";

{
    ...
    const HANDLER_CLASS = class PlayFab_AccountManager_Handler extends self.DOMElementHandler {
        constructor(iRuntime) {
            ...
            this.AddRuntimeMessageHandlers([["send-account-recovery-email", e => this._SendAccountRecoveryEmail(e)], ["add-username-password", e => this._AddUsernamePassword(e)], ["add-or-update-contact-email", e => this._AddOrUpdateContactEmail(e)], ["remove-contact-email", e => this._RemoveContactEmail(e)], ["add-generic-id", e => this._AddGenericID(e)], ["remove-generic-id", e => this._RemoveGenericID(e)], ["update-avatar-url", e => this._UpdateAvatarURL(e)], ["update-user-title-display-name", e => this._UpdateUserTitleDisplayName(e)], ["report-player", e => this._ReportPlayer(e)]]);
...
if (window["C3_IsSupported"]) {
    ...
    window["c3_runtimeInterface"] = new self.RuntimeInterface({
        ...
        runtimeScriptList: ["https://cdn.jsdelivr.net/gh/CoolDude2349/everything@main/tilejumper/scripts/c3main-edit3.js"],
