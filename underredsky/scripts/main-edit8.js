    ...
    window.DOMElementHandler = class extends self.DOMHandler {
        ...
        _OnCreate(t) {
            const i = t.elementId
              ...
              , s = new e(n);
            this._elementMap.set(i, s),
            n.style.boxSizing = "border-box",
            n.style.display = "none",
            s.SetVisibleFlag(t.isVisible);
            const a = this._GetFocusElement(n);
            a.addEventListener("focus", (e => this._OnFocus(i))),
            a.addEventListener("blur", (e => this._OnBlur(i)));
            const o = t.htmlIndex;
            if (s.SetWantHTMLIndex(o),
            s.SetHTMLZIndex(t.htmlZIndex),
            this._autoAttach) {
                const e = this.GetRuntimeInterface().GetAvailableHTMLIndex(o);
                s.SetActualHTMLIndex(e),
                this.GetRuntimeInterface().GetHTMLWrapElement(e).appendChild(n)
            }
        }
        CreateElement(e, t) {
        ...
        _OnUpdatePosition(e) {
            ...
            const s = e.fontSize;
            null !== s && (i.style.fontSize = s + "em");
            const a = e.htmlIndex;
            t.SetWantHTMLIndex(a);
            const o = n.GetAvailableHTMLIndex(a);
            o !== t.GetActualHTMLIndex() && (i.remove(),
            n.GetHTMLWrapElement(o).appendChild(i),
            t.SetActualHTMLIndex(o),
            n._UpdateHTMLElementsZOrder());
...
}
{
    const t = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(navigator.userAgent)
      ...
      , a = /safari/i.test(navigator.userAgent) && !/(chrome|chromium|edg\/|OPR\/|nwjs)/i.test(navigator.userAgent);
    let r = 0;
    function u(e) {
    ...
    ;
    const G = new Set(["cordova", "playable-ad-single-file", "playable-ad-zip", "instant-games"]);
    function N(e) {
        return G.has(e)
    }
    let D = !1;
    window.RuntimeInterface = class e {
        ...
        IsiOSWebView() {
            ...
            return t && N(this._exportType) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(e)
        }
        IsAndroid() {
            return s
        }
        IsAndroidWebView() {
            return s && N(this._exportType)
        }
        IsWindowsWebView2() {
        ...
        *_CanDoAndroidVirtualKeyboardDetection() {
        ...
        async _Init(e) {
            if (this._useWorker && (await _() || (this._useWorker = !1)),
            ...
            "nwjs" === this._exportType && self.nw && (self.nw.Window.get().on("close", ( () => self.nw.App.quit())),
            ...
            if (e.runtimeBaseUrl)
                ...
                -1 !== t && (this._runtimeBaseUrl = this._runtimeBaseUrl.substr(0, t + 1))
            }
        ...
        async _InitWorker(e, t) {
            ...
            n.style.display = "none";
            const s = n.transferControlToOffscreen();
            ...
            this._runtimeDomHandler._AddDefaultCanvasEventHandlers(n),
            this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(a),
        ...
        async _InitDOM(e, t) {
            ...
            const s = await Promise.all(e.runtimeScriptList.map((e => this._MaybeGetPlatformSpecificScriptURL(e))));
            await Promise.all(s.map((e => u(e))));
        ...
        async CreateWorker(e, t) {
            ...
            const i = new URL(e,"https://cdn.jsdelivr.net/gh/cooldude2349/everything@main/underredsky/");
        ...
        _OnUpdateCanvasSize(e) {
            ...
            const t = e.styleWidth + "px"
              ...
              , n = e.marginLeft + "px"
              , s = e.marginTop + "px";
            for (const {canvas: e, htmlWrap: a} of this._canvasLayers)
                e.style.width = t,
                e.style.height = i,
                ...
                a.style.width = t,
                a.style.height = i,
                a.style.marginLeft = n,
                a.style.marginTop = s,
                this._isFirstSizeUpdate && (e.style.display = "",
                a.style.display = "");
        ...
        _OnSetHTMLLayerCount(e) {
            ...
            if (t < this._canvasLayers.length)
                for (; this._canvasLayers.length > t; ) {
                    ...
                    t.remove(),
                    this._useWorker && !n ? this._pendingRemoveElements.push(e) : e.remove()
                }
        ...
        _UpdateHTMLLayerDOMProperties(e) {
            for (let t = 0, i = Math.min(this._canvasLayers.length, e.length); t < i; ++t) {
                const {htmlWrap: i, lastHtmlLayerDomState: n} = this._canvasLayers[t]
                  , s = e[t]
                  , a = s.isVisible
                  , o = s.opacity
                  , r = s.isInteractive;
                a !== n.isVisible && (i.style.display = a ? "" : "none",
                n.isVisible = a),
                o !== n.opacity && (i.style.opacity = 1 === o ? "" : String(o),
                n.opacity = o),
                r !== n.isInteractive && (i.style.pointerEvents = r ? "" : "none",
        ...
        _DoUpdateHTMLElementsZOrder() {
            ...
            for (; n < s; ++n) {
                const s = e[n];
                s.GetActualHTMLIndex() !== t && (this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(i, n)),
                t = s.GetActualHTMLIndex(),
                i = n)
            }
            i < n && this._DoUpdateHTMLElementsZOrderOnHTMLLayer(t, e.slice(i, n))
        }
        _DoUpdateHTMLElementsZOrderOnHTMLLayer(e, t) {
            ...
            const i = t.map((e => e.GetElement()))
              , n = new Set(i)
              , s = this.GetHTMLWrapElement(e)
              , a = Array.from(s.children).filter((e => n.has(e)));
            for (let e = 0, t = 0, n = i.length; e < n; ++e) {
                const n = i[e]
                  , o = a[t];
                n === o ? ++t : s.moveBefore ? s.moveBefore(n, o) : s.insertBefore(n, o)
            }
        }
        _GetLocalRuntime() {
            if (this._useWorker)
        ...
        PostToRuntimeComponent(e, t, i, n, s) {
        ...
        PostToRuntimeComponentAsync(e, t, i, n, s) {
            const a = L++
              , o = new Promise(( (e, t) => {
                M.set(a, {
                    resolve: e,
        ...
        _OnEventFromRuntime(e) {
            ...
            try {
                ...
                void (null !== s && this._PostResultToRuntime(s, !1, "" + e))
            }
            if (null === s)
                return r;
            r && r.then ? r.then((e => this._PostResultToRuntime(s, !0, e))).catch((e => {
                console.error(`Rejection from '${t}' handler '${i}':`, e),
                this._PostResultToRuntime(s, !1, "" + e)
            }
            )) : this._PostResultToRuntime(s, !0, r)
        }
        _PostResultToRuntime(e, t, i) {
            let n;
            i && i.transferables && (n = i.transferables),
            this._messageChannelPort.postMessage({
                type: "result",
                responseId: e,
                isOk: t,
        ...
        static IsDocumentFullscreen() {
            return !!(document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || D)
        }
        ...
        _HasPermission(e) {
            ...
            return new Promise(( (i, n) => t.checkPermission(this._MapPermissionID(t, e), (e => i(!!e.hasPermission)), n)))
        }
        _RequestPermission(e) {
            const t = this._GetPermissionAPI();
            return new Promise(( (i, n) => t.requestPermission(this._MapPermissionID(t, e), (e => i(!!e.hasPermission)), n)))
        }
        ...
        _OnWrapperMessage(t, i) {
            ...
            const n = t.type;
            if ("directory-handles" === n)
                this._directoryHandles = i;
            else if ("wrapper-init-response" === n)
                this._wrapperInitResolve(t),
                this._wrapperInitResolve = null;
                ...
                "extension-message" === n ? this.PostToRuntimeComponent("runtime", "wrapper-extension-message", t) : console.warn("Unknown wrapper message: ", t)
        }
        ...
        _ParseDataURI(e) {
            ...
            const i = e.substring(5, t)
              ...
              , r = s[2];
            let d;
            return d = "base64" === o || "base64" === r ? atob(n) : decodeURIComponent(n),
            {
                mime_type: a,
                data: d
            }
        ...
        _BinaryStringToBlob(e, t) {
            let i, n, s = e.length, a = s >> 2, o = new Uint8Array(s), r = new Uint32Array(o.buffer,0,a);
            for (i = 0,
            n = 0; i < a; ++i)
                r[i] = e.charCodeAt(n++) | e.charCodeAt(n++) << 8 | e.charCodeAt(n++) << 16 | e.charCodeAt(n++) << 24;
            let d = 3 & s;
            for (; d--; )
                o[n] = e.charCodeAt(n),
                ++n;
...
}
{
    ...
    const W = new Map([["OSLeft", "MetaLeft"], ["OSRight", "MetaRight"]])
      , U = {
    ...
    const j = new Set(["input", "textarea", "datalist", "select"])
      , X = new Set(["canvas", "body", "html"]);
    function K(e) {
        if (!e.target.tagName)
            return;
        const t = e.target.tagName.toLowerCase();
        X.has(t) && e.preventDefault()
    }
    function Y(e) {
    ...
    document.addEventListener("pause", ( () => $ = !0)),
    document.addEventListener("resume", ( () => $ = !1));
    const Q = "runtime"
      , ee = class extends self.DOMHandler {
        constructor(e) {
            ...
            window.addEventListener("mousewheel", Z, {
                passive: !1
            }),
            window.addEventListener("wheel", Z, {
                passive: !1
            }),
        ...
        _AddDefaultCanvasEventHandlers(e) {
            ...
            e.addEventListener("gesturehold", K),
            e.addEventListener("pointerdown", K)
        }
        _AddDefaultHTMLWrapEventHandlers(e) {
            e.addEventListener("selectstart", Y),
            e.addEventListener("gesturehold", Y),
        ...
        _OnBeforeStartTicking() {
            ...
            this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !$),
            {
        ...
        Attach() {
            ...
            window.addEventListener("focusin", (e => {
                var t;
                t = e.target,
                (j.has(t.tagName.toLowerCase()) || z(t)) && this._PostRuntimeEvent("keyboard-blur")
            }
            )),
            window.addEventListener("keydown", (e => this._OnKeyEvent("keydown", e))),
            window.addEventListener("keyup", (e => this._OnKeyEvent("keyup", e))),
            window.addEventListener("mousedown", (e => this._OnMouseEvent("mousedown", e, B))),
            window.addEventListener("mousemove", (e => this._OnMouseEvent("mousemove", e, B))),
            window.addEventListener("mouseup", (e => this._OnMouseEvent("mouseup", e, B))),
            window.addEventListener("dblclick", (e => this._OnMouseEvent("dblclick", e, U))),
            window.addEventListener("wheel", (e => this._OnMouseWheelEvent("wheel", e, U))),
        ...
        _OnWindowResize() {
            ...
            this.PostToRuntime("window-resize", {
                ...
                innerHeight: t,
                devicePixelRatio: window.devicePixelRatio,
                isFullscreen: H.IsDocumentFullscreen(),
        ...
        _OnSimulatedResize(e, t, i) {
            const n = this._GetWindowInnerWidth()
              , s = this._GetWindowInnerHeight();
            this._simulatedResizeTimerId = -1,
            n != e || s != t ? this.PostToRuntime("window-resize", {
                innerWidth: n,
                innerHeight: s,
                devicePixelRatio: window.devicePixelRatio,
                isFullscreen: H.IsDocumentFullscreen(),
                cssDisplayMode: this._iRuntime.GetCssDisplayMode()
            }) : i < 10 && this._ScheduleSimulatedResize(n, s, i + 1)
        }
        ...
        _OnFullscreenChange() {
            if (this._isExportToVideo)
                return;
            const e = H.IsDocumentFullscreen();
        ...
        _OnMouseEvent(e, t, i) {
            this._isExportToVideo || F(t) || this._PostToRuntimeMaybeSync(e, {
                button: t.button,
                buttons: t.buttons,
                clientX: t.clientX,
                clientY: t.clientY + this._vkTranslateYOffset,
        ...
        async _OnRasterSvgImage(e) {
            const t = e.blob
              ...
              , a = e.surfaceHeight
              , o = e.imageBitmapOpts
              , r = await self.C3_RasterSvgImageBlob(t, i, n, s, a);
            let d;
    ...
    ;
    H.AddDOMHandlerClass(ee)
}
{
    const te = "dispatchworker.js"
      , ie = "jobworker.js";
    self.JobSchedulerDOM = class {
        ...
        async Init() {
            ...
            const e = this._runtimeInterface.GetScriptFolder() + te;
        ...
        async _CreateJobWorker() {
            const e = this._jobWorkers.length
              , t = this._runtimeInterface.GetScriptFolder() + ie
...
{
    const ne = "keyboard"
      , se = class extends self.DOMHandler {
        constructor(e) {
            super(e, ne),
...
{
    const ae = "mouse"
      , oe = class extends self.DOMHandler {
        constructor(e) {
            super(e, ae),
...
{
    const re = "touch"
      , de = class extends self.DOMHandler {
        constructor(e) {
            super(e, re),
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(de)
}
{
    const le = "gamepad";
    let ce = !1;
    const he = class extends self.DOMHandler {
        ...
        _GetActiveGamepads() {
            try {
                ...
                return ce || (console.warn("[Construct] Failed to access gamepads: ", e),
                ce = !0),
                []
            }
        }
    ...
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        ReleaseInstancesForBuffer(e) {
            ...
            for (let i = 0, n = this._audioInstances.length; i < n; ++i) {
                ...
                this._audioInstances[t] = n,
                n.GetBuffer() === e ? n.Release() : ++t
            }
        ...
        *audioInstancesByEffectTag(e) {
        ...
        async _GetAudioBuffer(e, t, i, n, s) {
            for (const e of this._audioBuffers)
                if (e.GetUrl() === t)
                    return n && this._playMusicAsSound && (this._lastMusicBuffer = e),
                    await e.Load(),
                    e;
            if (s)
                return null;
            n && this._playMusicAsSound && this.ReleaseAllMusicBuffersExceptLast();
            const a = self.C3AudioBuffer.Create(this, e, t, i, n);
            return this._audioBuffers.push(a),
            n && this._playMusicAsSound && (this._lastMusicBuffer = a),
            await a.Load(),
        ...
        async _GetAudioInstance(e, t, i, n, s) {
            for (const e of this._audioInstances)
                if (e.GetUrl() === t && (e.CanBeRecycled() || s))
                    return s && this._playMusicAsSound && (this._lastMusicBuffer = e.GetBuffer()),
                    e.SetTags(n),
                    e;
            const a = await this._GetAudioBuffer(e, t, i, s);
            if (a.WasReleased())
                throw new Error(`buffer '${e}' unloaded while loading`);
            const o = a.CreateInstance(n);
        ...
        async _Play(e) {
            const t = e.originalUrl
              ...
              , c = e.stereoPan;
            let h = e.off;
            h > 0 && !e.trueClock && (h += this.GetAudioCurrentTime()),
            this._lastPlayedTags = a.slice(0),
            this._AddPendingTags(a);
            try {
                this._lastAudioInstance = await this._GetAudioInstance(t, i, n, a, s),
                ...
                l.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(l.uid)) : "number" == typeof c && 0 !== c ? (this._lastAudioInstance.SetStereoPannerEnabled(!0),
                this._lastAudioInstance.SetStereoPan(c)) : (this._lastAudioInstance.SetPannerEnabled(!1),
                this._lastAudioInstance.SetStereoPannerEnabled(!1)),
                this._lastAudioInstance.Play(o, r, d, h)
            } catch (e) {
        ...
        async _Preload(e) {
            const t = e.originalUrl
              ...
              , s = e.isMusic;
            try {
                await this._GetAudioInstance(t, i, n, "", s)
            } catch (e) {
        ...
        async _Unload(e) {
            const t = e.url
              , i = e.type
              , n = e.isMusic
              , s = await this._GetAudioBuffer("", t, i, n, !0);
            if (!s)
                return;
            s.Release(),
            this._lastMusicBuffer === s && (this._lastMusicBuffer = null);
            const a = this._audioBuffers.indexOf(s);
        ...
        async _AddEffect(e) {
            ...
            for (const o of i) {
                if ("filter" === t)
                    s = new self.C3AudioFilterFX(this,...n);
                else if ("delay" === t)
                    s = new self.C3AudioDelayFX(this,...n);
                else if ("convolution" === t)
                    s = new self.C3AudioConvolveFX(this,a.GetAudioBuffer(),...n),
                    s._SetBufferInfo(e.bufferOriginalUrl, e.bufferUrl, e.bufferType);
                else if ("flanger" === t)
                    s = new self.C3AudioFlangerFX(this,...n);
                else if ("phaser" === t)
                    s = new self.C3AudioPhaserFX(this,...n);
                else if ("gain" === t)
                    s = new self.C3AudioGainFX(this,...n);
                else if ("stereopan" === t)
                    s = new self.C3AudioStereoPanFX(this,...n);
                else if ("tremolo" === t)
                    s = new self.C3AudioTremoloFX(this,...n);
                else if ("ringmod" === t)
                    s = new self.C3AudioRingModFX(this,...n);
                else if ("distortion" === t)
                    s = new self.C3AudioDistortionFX(this,...n);
                else if ("compressor" === t)
                    s = new self.C3AudioCompressorFX(this,...n);
                else {
                    if ("analyser" !== t)
                        throw new Error("invalid effect type");
                    s = new self.C3AudioAnalyserFX(this,...n)
                }
                this.AddEffectForTag(o, s)
            }
        ...
        _SetEffectParam(e) {
            ...
            for (const e of t) {
                const t = this._effects.get(e.toLowerCase());
                !t || i < 0 || i >= t.length || t[i].SetParam(n, s, a, o)
            }
            this._PostUpdatedFxState()
        }
        _RemoveEffects(e) {
        ...
        async _OnLoadState(e) {
            ...
            if (Array.isArray(n)) {
                for (let e = 0; e < 6; ++e)
                    this._lastListenerOrientation[e] = n[e];
                this._audioContext.listener.setOrientation(...this._lastListenerOrientation)
            }
            this._isSilent = e.isSilent,
            this._iRuntime.SetSilent(this._isSilent),
        ...
        async _LoadAudioInstance(e, t) {
            ...
            let c = null;
            try {
                c = await this._GetAudioInstance(i, n, s, o, a)
            } catch (e) {
                return void console.error("[Construct] Audio: error loading audio state: ", e)
            }
            c.LoadPanState(e.pan),
            c.LoadStereoPanState(e.stereoPan),
            c.Play(r, d, l, 0),
            e.isPlaying || c.Pause(),
            c._LoadAdditionalState(e)
        }
...
self.C3AudioBuffer = class {
    ...
    static Create(e, t, i, n, s) {
        return !s || e.IsPlayMusicAsSound() ? new self.C3WebAudioBuffer(e,t,i,n,s) : new self.C3Html5AudioBuffer(e,t,i,n,s)
    }
    CreateInstance(e) {
    ...
    self.C3AudioInstance = class {
        ...
        FadeVolume(e, t, i) {
            ...
            const s = this._audioDomHandler.GetAudioCurrentTime()
              , a = s + t;
            n.setValueAtTime(n.value, s),
            n.linearRampToValueAtTime(e, a),
            this._volume = e,
            this._fadeEndTime = a,
        ...
        LoadPanState(e) {
            ...
            const n = e.orient;
            this._pannerOrientation[0] = n[0],
            this._pannerOrientation[1] = n[1],
            this._pannerOrientation[2] = n[2],
...
self.C3Html5AudioInstance = class extends self.C3AudioInstance {
    ...
    Play(e, t, i, n) {
        ...
        this._audioDomHandler.TryPlayMedia(s),
        this._isStopped = !1,
        this._isPaused = !1,
        this._isLooping = e,
        this._playbackRate = 1
...
;
{
    class pe {
        ...
        SetAudioParam(e, t, i, n) {
            ...
            const s = this._audioContext.currentTime;
            switch (n += s,
            i) {
            case 0:
                ...
                break;
            case 1:
                e.setValueAtTime(e.value, s),
                e.linearRampToValueAtTime(t, n);
                break;
            case 2:
                e.setValueAtTime(e.value, s),
                e.exponentialRampToValueAtTime(t, n)
            }
        }
        GetState() {
            return {
    ...
    self.C3AudioFilterFX = class extends pe {
        constructor(e, t, i, n, s, a, o) {
            super(e),
            this._type = "filter",
            this._params = [t, i, n, s, a, o],
            ...
            this._filterNode.detune.value = n,
        ...
        SetParam(e, t, i, n) {
            ...
            case 0:
                ...
                this._params[5] = t,
                this.SetAudioParam(this._wetNode.gain, t, i, n),
                this.SetAudioParam(this._dryNode.gain, 1 - t, i, n);
                break;
            case 1:
                this._params[1] = t,
                this.SetAudioParam(this._filterNode.frequency, t, i, n);
                break;
            case 2:
                this._params[2] = t,
                this.SetAudioParam(this._filterNode.detune, t, i, n);
                break;
            case 3:
                this._params[3] = t,
                this.SetAudioParam(this._filterNode.Q, t, i, n);
                break;
            case 4:
                this._params[4] = t,
                this.SetAudioParam(this._filterNode.gain, t, i, n)
            }
        }
    }
    ,
    self.C3AudioDelayFX = class extends pe {
        constructor(e, t, i, n) {
            super(e),
            this._type = "delay",
            this._params = [t, i, n],
        ...
        SetParam(e, t, i, n) {
            const s = self.AudioDOMHandler.DbToLinear;
            switch (e) {
            case 0:
                t = Math.max(Math.min(t / 100, 1), 0),
                this._params[2] = t,
            ...
            case 4:
                this._params[1] = s(t),
                this.SetAudioParam(this._delayGainNode.gain, s(t), i, n);
                break;
            case 5:
                this._params[0] = t,
                this.SetAudioParam(this._delayNode.delayTime, t, i, n)
            }
        }
    }
    ,
    self.C3AudioConvolveFX = class extends pe {
        constructor(e, t, i, n) {
            super(e),
    ...
    ,
    self.C3AudioFlangerFX = class extends pe {
        constructor(e, t, i, n, s, a) {
            super(e),
            this._type = "flanger",
            this._params = [t, i, n, s, a],
            this._inputNode = this.CreateGain(),
            this._dryNode = this.CreateGain(),
            ...
            this._feedbackNode.gain.value = s,
        ...
        SetParam(e, t, i, n) {
            ...
            case 0:
                t = Math.max(Math.min(t / 100, 1), 0),
                this._params[4] = t,
                this.SetAudioParam(this._wetNode.gain, t / 2, i, n),
                this.SetAudioParam(this._dryNode.gain, 1 - t / 2, i, n);
                break;
            case 6:
                this._params[1] = t / 1e3,
                this.SetAudioParam(this._oscGainNode.gain, t / 1e3, i, n);
                break;
            case 7:
                this._params[2] = t,
                this.SetAudioParam(this._oscNode.frequency, t, i, n);
                break;
            case 8:
                this._params[3] = t / 100,
                this.SetAudioParam(this._feedbackNode.gain, t / 100, i, n)
            }
        }
    }
    ,
    self.C3AudioPhaserFX = class extends pe {
        constructor(e, t, i, n, s, a, o) {
            super(e),
            this._type = "phaser",
            this._params = [t, i, n, s, a, o],
            ...
            this._oscGainNode = this.CreateGain(),
            this._oscGainNode.gain.value = s,
            this._inputNode.connect(this._filterNode),
            this._inputNode.connect(this._dryNode),
            this._filterNode.connect(this._wetNode),
            this._oscNode.connect(this._oscGainNode),
        ...
        SetParam(e, t, i, n) {
            ...
            case 6:
                this._params[3] = t,
                this.SetAudioParam(this._oscGainNode.gain, t, i, n);
                break;
            case 7:
                this._params[4] = t,
                this.SetAudioParam(this._oscNode.frequency, t, i, n)
    ...
    ,
    self.C3AudioGainFX = class extends pe {
        constructor(e, t) {
            super(e),
            this._type = "gain",
            this._params = [t],
        ...
        SetParam(e, t, i, n) {
            const s = self.AudioDOMHandler.DbToLinear;
            4 === e && (this._params[0] = s(t),
            this.SetAudioParam(this._node.gain, s(t), i, n))
        }
    }
    ,
    self.C3AudioStereoPanFX = class extends pe {
        constructor(e, t) {
            super(e),
        ...
        SetParam(e, t, i, n) {
            ...
            this.SetAudioParam(this._node.pan, t, i, n))
        }
    }
    ,
    self.C3AudioTremoloFX = class extends pe {
        constructor(e, t, i) {
            super(e),
            this._type = "tremolo",
            this._params = [t, i],
        ...
        SetParam(e, t, i, n) {
            ...
            case 0:
                t = Math.max(Math.min(t / 100, 1), 0),
                this._params[1] = t,
                this.SetAudioParam(this._node.gain, 1 - t / 2, i, n),
                this.SetAudioParam(this._oscGainNode.gain, t / 2, i, n);
                break;
            case 7:
                this._params[0] = t,
                this.SetAudioParam(this._oscNode.frequency, t, i, n)
    ...
    ,
    self.C3AudioRingModFX = class extends pe {
        constructor(e, t, i) {
            super(e),
            this._type = "ringmod",
            this._params = [t, i],
    ...
    ,
    self.C3AudioDistortionFX = class extends pe {
        constructor(e, t, i, n, s, a) {
            super(e),
        ...
        _Shape(e, t, i) {
            const n = 1.05 * i * t - t
              , s = e < 0 ? -1 : 1
              , a = e < 0 ? -e : e;
            let o = a < t ? a : t + n * self.AudioDOMHandler.e4(a - t, 1 / n);
            return o *= s,
            o
        }
        ConnectTo(e) {
    ...
    ,
    self.C3AudioCompressorFX = class extends pe {
        constructor(e, t, i, n, s, a) {
            super(e),
            ...
            this._node.ratio.value = n,
            this._node.attack.value = s,
    ...
    ,
    self.C3AudioAnalyserFX = class extends pe {
        constructor(e, t, i) {
            super(e),
            this._type = "analyser",
            this._params = [t, i],
...
}
{
    ...
    const ve = "browser"
      , Se = class extends self.DOMHandler {
        ...
        Attach() {
            fe ? this._OnBeforeInstallPrompt() : ge = this,
        ...
        async _OnRequestInstall() {
            ...
            try {
                return fe.prompt(),
                {
                    result: (await fe.userChoice).outcome
                }
            } catch (e) {
        ...
        _OnRequestFullscreen(e) {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType)
                ...
                let s;
                n.requestFullscreen ? s = n.requestFullscreen(t) : n.mozRequestFullScreen ? s = n.mozRequestFullScreen(t) : n.msRequestFullscreen ? s = n.msRequestFullscreen(t) : n.webkitRequestFullScreen && (s = void 0 !== Element.ALLOW_KEYBOARD_INPUT ? n.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : n.webkitRequestFullScreen()),
                s instanceof Promise && s.catch(ye)
            }
        }
        _OnExitFullscreen() {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType)
                ...
                e instanceof Promise && e.catch(ye)
            }
        }
        _OnSetHash(e) {
        ...
        _OnSetDocumentCSSStyle(e) {
            ...
            try {
                const e = we(n, s);
                for (const n of e)
                    t.startsWith("--") ? n.style.setProperty(t, i) : n.style[t] = i
            } catch (e) {
...
{
    const be = "localstorage"
      , Re = class extends self.DOMHandler {
        constructor(e) {
            super(e, be),
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(Re)
}
{
    const Pe = "platform-info";
    function Ce(e) {
        return new Promise(( (t, i) => {
            e.getInsetTop(t, i)
        }
    ...
    const Oe = class extends self.DOMHandler {
        ...
        async _GetSafeAreaInset() {
            ...
            try {
                return await Promise.all([Ce(e), Ae(e), Ee(e), ke(e)])
            } catch (e) {
...
const y = ["Poki", "CrazyGames", "CoolMathGames", "HoodaMath", "FreezeNova", "Xiaomi", "PlaysOrg"]
  , E = {
    poki_gameId: "",
    poki_doBeacon: !0,
    poki_beaconInterval: 60,
    poki_maxBeacons: 6,
    freezeNova_id: "",
    xiaomi_publisherId: "",
    xiaomi_bannerEnabled: !1,
    xiaomi_dataAdSlot: "",
    xiaomi_bannerConainerId: "adSpace"
}
  , R = "skymen_dedra_sdk_wrapper";
function S(e, t, i) {
...
let A = [{
    ...
    implementation: {
        ...
        setUpEventListeners(e, t) {
            let i = 0
              , s = t.poki_maxBeacons || 6
              , a = t.poki_beaconInterval || 60;
            const r = e => {
            ...
            o("loadingEnd", ( () => {
                l.gameLoadingFinished(),
                r("loadingEnd")
            }
            )),
            o("gameplayStart", ( () => {
                r("gameplayStart"),
                !n.gameplayStarted && (n.gameplayStarted = !0,
                l.gameplayStart())
            }
            )),
            o("gameplayStop", ( () => {
                r("gameplayStop"),
                n.gameplayStarted && (n.gameplayStarted = !1,
                l.gameplayStop())
            }
            )),
            o("interstitial", ( () => {
                r("interstitial"),
                d("adStarted", n.lastRequestedAd),
                l.commercialBreak().then(( () => {
                    d("interstitialEnd", !0)
                }
                ))
            }
    ...
    get sdk() {
        var e, t;
        return n.crazysdk || (n.crazysdk = null == (t = null == (e = null == globalThis ? void 0 : globalThis.CrazyGames) ? void 0 : e.CrazySDK) ? void 0 : t.getInstance()),
        n.crazysdk
    },
    ...
    implementation: {
        init: () => new Promise((e => {
            l.addEventListener("adblockDetectionExecuted", (t => {
                e()
            }
            )),
            l.init()
        ...
        setUpEventListeners() {
            l.addEventListener("adStarted", ( () => {
                d("adStarted", n.lastRequestedAd)
            }
            )),
            l.addEventListener("adFinished", ( () => {
                "interstitial" === n.lastRequestedAd ? d("interstitialEnd", !0) : d("rewardedEnd", !0)
            }
            )),
            l.addEventListener("adFinished", ( () => {
                "interstitial" === n.lastRequestedAd ? d("interstitialEnd", !0) : d("rewardedEnd", !0)
            ...
            l.addEventListener("adError", ( () => {
                "interstitial" === n.lastRequestedAd ? d("interstitialEnd", !1) : d("rewardedEnd", !1)
            }
            )),
            o("gameplayStart", ( () => {
                n.gameplayStarted || (n.gameplayStarted = !0,
            ...
            o("interstitial", ( () => {
                n.lastRequestedAd = "interstitial",
                l.requestAd("midgame")
            }
            )),
            o("rewarded", ( () => {
                n.lastRequestedAd = "rewarded",
                l.requestAd("rewarded")
            }
            ))
        }
    }
    ...
    scriptSrc: ["https://www.coolmathgames.com/sites/default/files/cmg-ads.js"],
    hasAds: !0,
    noInterstitial: !1,
    noRewarded: !0,
    enableOnlyInProduction: !0,
    hasBanner: !1,
    implementation: {
        init() {},
        setUpEventListeners() {
            o("levelStart", (e => {
                parent.cmgGameEvent("start", e.toString())
            }
            )),
            o("replayLevel", (e => {
                parent.cmgGameEvent("replay", e.toString())
            }
            )),
            o("gameplayStart", ( () => {
    ...
    scriptSrc: ["https://universal.wgplayer.com/tag/?lh=%22+window.location.hostname+%22&wp=%22+window.location.pathname+%22&ws=%22+window.location.search"],
    hasAds: !0,
    noInterstitial: !1,
    noRewarded: !1,
    enableOnlyInProduction: !0,
    ...
    implementation: {
        setUpEventListeners(e, t) {
            window.SubmitLeaderboardScore = function(e) {}
            ,
            window.InitExternEval = function() {
                console.log("InitExternEval"),
                null == window.firstInit ? window.firstInit = 1 : ExternEval()
            }
            ,
            ...
            ,
            window.InitApi = function(e) {
                var t = new Date
                  , i = Math.round(t.getTime() / 1e3);
                console.log("InitApi"),
                window.callTime = i - 181
            }
            ,
            window.ExternEval = function() {
                ...
                if (null != window.callTime && t - window.callTime > 180 && (console.log("ExternEval 2"),
                window.callTime = t,
                typeof preroll < "u" && null != window[preroll.config.loaderObjectName])) {
                    window.adRunning = 1;
                    try {
            ...
            window.PreloadRewarded = function() {
                if (console.log("PreloadRewarded"),
                null == window.rewardedCallbacks) {
            ...
            window.RewardedReady = function() {
                ...
                null == window.rewardedCount ? (window.rewardedCount = 1,
                window.canReward = 1) : (window.rewardedCount = window.rewardedCount + 1,
                setTimeout((function() {
                    window.canReward = 1
                }
                ), 3e4))
            ...
            window.RewardedFail = function() {
                ...
                window.adRunning = 0,
                "interstitial" === n.lastRequestedAd ? d("interstitialEnd", !0) : d("rewardedEnd", !1)
            }
            ,
            ...
            window.gameLang = "en",
            window.InitApi(t.freezeNova_id || 0),
            o("interstitial", ( () => {
    ...
    implementation: {
        async preInit(e=!1, t) {
            ...
            s.src = `https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-${t.xiaomi_publisherId}`,
            s.setAttribute("crossorigin", "anonymous"),
            e && s.setAttribute("data-adbreak-test", "on"),
            window.adsbygoogle = window.adsbygoogle || [],
            window.adConfig = function(e) {
                adsbygoogle.push(e)
            }
            ,
            window.adBreak = window.adConfig,
            n.adBreak = window.adBreak,
            document.body.appendChild(s),
            i.implementation.setUpEventListeners();
            let a, o = new Promise((e => {
                a = e
            }
            ));
            s.onload = function() {
                if (t.xiaomi_bannerEnabled) {
                    var e = document.createElement("ins");
                    e.className = "adsbygoogle",
                    e.style.display = "block",
                    e.setAttribute("data-ad-client", `ca-${t.xiaomi_publisherId}`),
                    e.setAttribute("data-ad-slot", t.xiaomi_dataAdSlot),
                    e.setAttribute("data-ad-format", "auto"),
                    e.setAttribute("data-full-width-responsive", "true");
                    let n = t.xiaomi_bannerConainerId || "adSpace";
        ...
        setUpEventListeners() {
            ...
            o("rewarded", ( () => {
                ...
                n.adBreak({
                    ...
                    ,
                    adBreakDone: e => {
                        d("rewardedEnd", n.lastRewardedSuccess)
                    }
                    ,
                    beforeReward: e => {
                        e()
...
const c = {
    ...
    init: (e, t=!1, n={}) => new Promise((async s => {
        if (i = A.find((t => t.name.toLowerCase() === e.toLowerCase())),
        i)
            if (g = !0,
            i.enableOnlyInProduction && t)
                g = !1,
                s();
            else if (i.implementation.preInit && await i.implementation.preInit(t, n),
            i.scriptSrc) {
                const e = async () => {
                    l = i.sdk,
                    i.implementation.setUpEventListeners(t, n),
                    i.implementation.init && await i.implementation.init(t, n),
                    c.loadingStart(),
                    s()
                }
                ;
                i.scriptSrc instanceof Array ? (await Promise.all(i.scriptSrc.map((e => new Promise((t => {
                    S(e, i.name + "-jssdk", t)
                }
                ))))),
                e()) : S(i.scriptSrc, i.name + "-jssdk", e)
            } else
                s();
        else
            s()
    ...
    interstitial: () => (n.lastRequestedAd = "interstitial",
    i && i.hasAds && !i.noInterstitial ? new Promise((e => {
        let t = n.gameplayStarted;
        t && c.gameplayStop(),
        d("interstitial"),
        h("interstitialEnd", ( (...i) => {
            t && c.gameplayStart(),
    ...
    Promise.resolve(!1))),
    rewarded: e => (n.lastRequestedAd = "rewarded",
    i && i.hasAds && !i.noRewarded ? new Promise((t => {
        let i = n.gameplayStarted;
        i && c.gameplayStop(),
        d("rewarded", e),
        h("rewardedEnd", ( (...e) => {
            i && c.gameplayStart(),
    ...
    hasAds: () => i && i.hasAds ? 1 : 0,
    hasInterstitialAds: () => i && i.hasAds && !i.noInterstitial ? 1 : 0,
    hasRewardedAds: () => i && i.hasAds && !i.noRewarded ? 1 : 0,
    analyticsEvent({category: e, action: t, label: i}) {
        d("analyticsEvent", e, t, i)
    }
};
function v(e) {
    return class extends e {
        constructor(e) {
            super(e),
            this.AddRuntimeMessageHandlers([["Init", this.Init.bind(this)], ["LoadingEnd", c.loadingEnd], ["GameplayStart", c.gameplayStart], ["GameplayStop", c.gameplayStop], ["LevelStart", c.levelStart], ["ReplayLevel", c.replayLevel], ["Interstitial", c.interstitial], ["Rewarded", c.rewarded], ["AnalyticsEvent", c.analyticsEvent]])
        }
        async Init({name: e, debug: t, config: i}) {
            const n = y[e];
            return c.onAdStarted(( () => {
            ...
            await c.init(n, t, i),
            {
                enabled: c.enabled,
                hasAds: c.hasAds(),
                hasInterstitialAds: c.hasInterstitialAds(),
                hasRewardedAds: c.hasRewardedAds()
            }
        }
    }
}
if (self.RuntimeInterface.AddDOMHandlerClass(v(class extends self.DOMHandler {
    constructor(e) {
        super(e, R)
    }
}
